	...
	<script type="text/javascript">
		...
		function selectWork(a, b) { // 부모창으로 값 넘기기
			...
			if (opener.document.getElementById("searchManager") != null) {
				...
				opener.document.getElementById("manager").dispatchEvent(
						new Event('input'));
				opener.document.getElementById("searchManager").dispatchEvent(
						new Event('input'));
				self.close();
				return;
			}
			...
			opener.document.getElementById("manager").dispatchEvent(
					new Event('input'));
			opener.document.getElementById("managerName").dispatchEvent(
					new Event('input'));
			self.close();
