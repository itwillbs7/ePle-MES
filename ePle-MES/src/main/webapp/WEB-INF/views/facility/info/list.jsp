							...
							<div id="faq1" class="collapse" data-parent="#accordion" style="">
								<div class="card-body">
									<form id="accordion-search" method="GET" action="#">
											...
											<div class="form-group">
													...
													<div class="col-md-5 col-sm-12 btn-group"
														...
														<div class="btn-group dropdown">
															...
															<div class="dropdown-menu" style="">
																<a class="dropdown-item" id="category-none"
																	href="javascript:buttonCategory(null);">선택</a>
																<c:forEach var="i" begin="0" end="4">
																	<a class="dropdown-item"
																		href="javascript:buttonCategory(${i});">${pageVO.search.kor[i]}</a>
																</c:forEach>
															</div>
														</div>
														...
														<input type="hidden" id="searchCategory"
															name="searchCategory"
															value="${pageVO.search.searchCategory}"> <input
															type="text" name="searchKeyword" class="form-control"
															style="width: 100%;"
															value="${pageVO.search.searchKeyword}"
															placeholder="검색어 입력">
													</div>
												</div>
												<hr>
												...
												<div class="row">
													<div class="col-md-2 col-sm-12">
														...
														<div class="custom-control custom-checkbox mb-5">
															<input type="checkbox" class="custom-control-input"
																id="formCheck1" name="formCheck" value="FACPRO">
															<label class="custom-control-label" for="formCheck1">생산</label>
														</div>
														<div class="custom-control custom-checkbox mb-5">
															<input type="checkbox" class="custom-control-input"
																id="formCheck2" name="formCheck" value="FACNPR">
															<label class="custom-control-label" for="formCheck2">비생산</label>
														</div>
														<div class="custom-control custom-checkbox mb-5">
															<input type="checkbox" class="custom-control-input"
																id="formCheck3" name="formCheck" value="FACETC">
															<label class="custom-control-label" for="formCheck3">기타</label>
														</div>
													</div>
													<div class="col-md-2 col-sm-12">
														...
														<c:choose>
															<c:when test="${pageVO.search.formRadio eq 'all'}">
																<div class="custom-control custom-radio mb-5">
																	<input type="radio" id="formRadio1" name="formRadio"
																		checked class="custom-control-input" value="all">
																	<label class="custom-control-label" for="formRadio1">전체</label>
																</div>
																<div class="custom-control custom-radio mb-5">
																	<input type="radio" id="formRadio2" name="formRadio"
																		class="custom-control-input" value="true"> <label
																		class="custom-control-label" for="formRadio2">활성화</label>
																</div>
																<div class="custom-control custom-radio mb-5">
																	<input type="radio" id="formRadio3" name="formRadio"
																		class="custom-control-input" value="false"> <label
																		class="custom-control-label" for="formRadio3">비활성화</label>
																</div>
															</c:when>
															<c:when test='${pageVO.search.formRadio eq trueText}'>
																<div class="custom-control custom-radio mb-5">
																	<input type="radio" id="formRadio1" name="formRadio"
																		...
																		class="custom-control-label" for="formRadio1">전체</label>
																</div>
																<div class="custom-control custom-radio mb-5">
																	<input type="radio" id="formRadio2" name="formRadio"
																		checked class="custom-control-input" value="true">
																	<label class="custom-control-label" for="formRadio2">활성화</label>
																</div>
																<div class="custom-control custom-radio mb-5">
																	<input type="radio" id="formRadio3" name="formRadio"
																		class="custom-control-input" value="false"> <label
															...
															<c:when test="${pageVO.search.formRadio eq falseText}">
																...
																<div class="custom-control custom-radio mb-5">
																	<input type="radio" id="formRadio3" name="formRadio"
																		checked class="custom-control-input" value="false">
																	<label class="custom-control-label" for="formRadio3">비활성화</label>
																</div>
															</c:when>
															<c:otherwise>
																<div class="custom-control custom-radio mb-5">
													...
													<div class="col-md-2 col-sm-12">
														<div class="form-group">
															<label>날짜</label> <input class="form-control date-picker"
																name="date" value="${pageVO.search.date}"
																data-language="ko" placeholder="일정 선택" type="text" />
														</div>
													</div>
													<div class="col-md-2 col-sm-12">
														<div class="form-group">
															<label>기간</label> <input
																class="form-control datetimepicker-range" name="between"
																value="${pageVO.search.between}" placeholder="기간 선택"
																type="text" />
														</div>
													</div>
												</div>
										...
										<!-- 정렬, asc, desc -->
										<input type="hidden" name="activeSortCategory"
											id="sortCategory" value="${pageVO.search.activeSortCategory}">
									...
									<c:forEach items="${list}" var="i">
										<tr>
											...
											<td><div class="custom-control custom-checkbox mb-5">
													...
													<input type="checkbox" class="custom-control-input"
														id="checkTable${i.code}" name="tableCheck"
														value="${i.code}"> <label
														class="custom-control-label" for="checkTable${i.code}"></label>
												</div></td>
											<th><a
												href="javascript:openPage('/facility/info/detail?code=${i.code}', 500, 600)"><b
													class="text-blue" id="tableTitle1">${i.code}</b></a></th>
											...
											<td style="">
												...
												<div class="dropdown">
													...
													<div
														...
														<!-- 상세 보기 -->
														<a class="dropdown-item"
															href="javascript:openPage('/facility/info/detail?code=${i.code}', 500, 600)"><i
															class="dw dw-eye"></i> 상세 보기</a>
														<!-- 수정 -->
														<a class="dropdown-item"
															href="javascript:openPage('/facility/info/update?code=${i.code}', 500, 600)"><i
															class="dw dw-edit2"></i> 수정</a>
														<!-- 삭제 -->
														<a class="dropdown-item"
															href="javascript:openPage('/facility/info/delete?code=${i.code}', 500, 600)"><i
