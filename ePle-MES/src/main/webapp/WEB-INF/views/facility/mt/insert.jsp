...
<body>
	<!-- 직원의 경우 사후보전만 실시 -->
	<!-- 관리자, 설비 보전 담당자의 경우 이외의 보전도 가능하게 함 -->
		...
		<div class="login-box bg-white box-shadow border-radius-10">
			...
			<div class="tab">
				<ul class="nav nav-pills" role="tablist">
					<li class="nav-item"><a class="nav-link text-blue active" data-toggle="tab" href="#home5" role="tab" aria-selected="true">사후 보전</a></li>
					<li class="nav-item"><a class="nav-link text-blue" data-toggle="tab" href="#profile5" role="tab" aria-selected="false">예방 보전</a></li>
					<li class="nav-item"><a class="nav-link text-blue" data-toggle="tab" href="#contact5" role="tab" aria-selected="false">예약 보전</a></li>
				</ul>
