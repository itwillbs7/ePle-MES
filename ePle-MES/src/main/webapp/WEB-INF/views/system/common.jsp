...
<body>
							...
							<form class="table" id="table">
								<table class="table table-striped">
									...
									<tr>
										...
										<th>그룹아이디 데이터들어가는곳</th>
										<!-- 상세 정보 이동! -->
										<th><a href="#"><b class="text-blue" id="tableTitle1">그룹명 데이터들어가는곳</b></a></th>
										<th>코드ID 데이터들어가는곳</th>
										<th>코드명 데이터들어가는곳</th>
										<th>정렬순서 데이터들어가는곳</th>
										<th>사용여부 데이터들어가는곳</th>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			$("#add").click(function() {
				// 가로, 세로 설정
				openPage("/system/add", 500, 600);
			});

			// 수정
			$("#update").click(function() {
				// 가로, 세로 설정
				openPage("/system/update", 400, 700);
			});

			// 삭제
			$("#delete").click(function() {
				// 가로, 세로 설정
				openPage("/system/delete", 400, 700);
			});
		});
	</script>
</body>
