			...
			<form action="/returns/update" method="get" id="addForm" onsubmit="">
				...
				<div class="row">
					<div class="col-sm-8 mb-3">
							...
							<textarea class="form-control" placeholder="반품사유를 입력하세요"
								name="reason" readonly style="height:80%;">${List.reason}</textarea>
						</div>
					<div class="col-sm-4 mb-3">
				...
				<div class="row" style="margin-bottom: 20px;">
					<div class="col-sm-3 mb-3">
						...
						<input class="form-control" type="text" readonly value="${List.reg_date }" id="reg_date">
					</div>
					<div class="col-sm-3 mb-3">
						<label style="font-weight: bold;">작성자 아이디</label> 
						<input class="form-control" type="text" readonly value="${List.reg_emp }">
					</div>
					<div class="col-sm-3 mb-3">
						<label style="font-weight: bold;">수정일자</label> 
						<input class="form-control" type="text" readonly value="${List.update_date }" id="update_date">
					</div>
					<div class="col-sm-3 mb-3">
						<label style="font-weight: bold;">수정자 아이디</label> 
						<input class="form-control" type="text" readonly value="${List.update_emp }">
					</div>
				</div>						<!-- 버튼 -->
						<div class="row">
							<div
