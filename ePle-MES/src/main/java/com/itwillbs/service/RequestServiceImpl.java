...
public class RequestServiceImpl implements RequestService {
	...
	@Override
	public List<RequestVO> findManager(RequestSearchVO vo) throws Exception {
		logger.debug("Service : findManager(RequestSearchVO vo) : "+vo);

		return rdao.searchManager(vo);
	}
